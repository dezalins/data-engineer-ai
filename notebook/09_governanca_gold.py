...
# MAGIC
# MAGIC E um passo que **não** dá para pular: revisar as descrições geradas pela IA uma a uma, contra o dado. Uma delas está errada.
...
# MAGIC
# MAGIC > *"Minutos que a etapa recuperou em voo. Valor positivo indica que o voo chegou adiantado."*
# MAGIC
# MAGIC Soa perfeito. E está errado — e o jeito de saber não é reler a frase, é **perguntar para o dado**.

# COMMAND ----------

voebem.gold.obt_voosdisplay(spark.sql("""
    SELECT
...
# MAGIC %md
# MAGIC **164.895 voos recuperaram tempo no ar e mesmo assim chegaram atrasados** — 75.082 deles com mais de 15 minutos de atraso. A descrição da IA teria feito qualquer pessoa (e qualquer LLM) concluir o contrário. 
# MAGIC
# MAGIC O certo é: *positivo significa que a etapa chegou **menos atrasada do que saiu**. Não quer dizer que chegou no horário.*
# MAGIC
# MAGIC A diferença entre as duas frases é a diferença entre "recuperou" e "resolveu". A segunda métrica, `chegada_pontual`, é quem responde se resolveu. Outras duas afirmações do rascunho que a revisão também derrubou:
# MAGIC
...
# MAGIC
# MAGIC A OBT é a tabela que a IA lê, mas o fato e a dimensão continuam sendo lidos por gente. Eles herdam as mesmas descrições onde a coluna é a mesma.
...
# MAGIC
# MAGIC Ninguém escreveu uma linha de código de rastreabilidade. O Unity Catalog registrou sozinho quem leu o quê para escrever o quê.
